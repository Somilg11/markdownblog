...
const Plans = () => {
  return (
    <div>
        <section className="py-12 bg-gray-100 dark:bg-zinc-950">
  <div className="container px-4 mx-auto">
    ...
    <div className="flex flex-wrap justify-center">
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-zinc-900 transform transition duration-500 hover:scale-105 text-center">
          <h3 className="text-2xl font-semibold text-zinc-900 dark:text-gray-200">Basic</h3>
      ...
      {/* Standard Plan */}
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-zinc-900 transform transition duration-500 hover:scale-105 text-center border-2 border-purple-500">
          <h3 className="text-2xl font-semibold text-zinc-900 dark:text-gray-200">Standard</h3>
      ...
      <div className="w-full sm:w-1/2 lg:w-1/3 p-4">
        <div className="p-6 bg-white rounded-lg shadow-lg dark:bg-zinc-900 transform transition duration-500 hover:scale-105 text-center">
          <h3 className="text-2xl font-semibold text-zinc-900 dark:text-gray-200">Premium</h3>
